...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: '',
            featured_image: '',
            apiUrl:'https://kokomora.devcamp.space/portfolio/portfolio_blogs',
            apiAction:'post'
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl:`https://kokomora.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction:'patch'
            });
        }
    }
    ...
    render() {
        ...
        return (
           ...
           <form onSubmit={this.handleSubmit} className='blog-form-wrapper'>
                ...
                {this.props.editMode && this.props.blog.featured_image_url ? (
                    ...
                    <div className='portfolio-manager-image-wrapper'>
                        ...
                        <div className='image-removal-link'>
                            <a onClick={() => this.deleteImage('featured_image')}>bye file</a>
            ...
            <button className='btn'>guardámelo, por favorcito</button>
           </form>
